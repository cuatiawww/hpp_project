...
// Colors
Color primary1 = const Color(0xFFF29100);
Color secondary = const Color(0xFF080C67);
...
Color bluebtn = const Color(0xFF027CFE);

// Typography
TextStyle regular12_5 =
    const TextStyle(fontFamily: 'Poppins', fontSize: 12.5);
